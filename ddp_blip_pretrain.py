...
class CheckpointManager:
    ...
    def __init__(self, output_dir, save_interval_mins=30, save_fraction=0.25):
...
# ============================================================================
# ============================================================================
# Training Script with DistributedDataParallel and Checkpointing
# ============================================================================
...
if __name__ == "__main__":
    # CRITICAL: Set spawn method for multiprocessing
    ...
    parser.add_argument('--train_json', type=str,default="/N/u/jkatama/BigRed200/BLIP/annotations_trainval2014/annotations/captions_train2014.json", help='Path to train annotations')
    parser.add_argument('--train_image_root', type=str,default='/N/u/jkatama/BigRed200/BLIP/train2014/train2014', help='Path to train images')
    parser.add_argument('--val_json', type=str,default='/N/u/jkatama/BigRed200/BLIP/annotations_trainval2014/annotations/captions_val2014.json', help='Path to val annotations')
    parser.add_argument('--val_image_root', type=str,default='/N/u/jkatama/BigRed200/BLIP/val2017/val2017', help='Path to val images')
